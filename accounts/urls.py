...
from accounts.views import (
    RegisterUserView, LoginView, LogoutView, ForgotPasswordView, VerifyOtpView, ResetPasswordView, UserView, ProfileViewUpdate
)
...
urlpatterns = [
    ...
    path('users/<int:id>/', UserView.as_view(), name='delete-user'),
